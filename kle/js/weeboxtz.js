    ...
    var weebox = function (content, options) {
        ...
        this.initBox = function () {
            ...
            switch (self.options.type) {
                ...
                case 'select':
                case 'dialog':
                    html = '<div id="weedialog" class="weedialog">' +
                        '	<div class="dialog-header">' +
                        '		<div class="dialog-tc">' +
                        '			<div class="dialog-tc2"><div class="left"></div><div class="right"></div><a href="javascript:;" onclick="return false" title="关闭" class="dialog-close"></a><span class="dialog-title"></span></div>' +
                        '		</div>' +
                        '	</div>' +
                        '	<div class="dialog-content"></div>' +
                        '	<div class="dialog-foot"><div class="left"></div><div class="mid"></div><div class="right"></div></div>' +
                        '</div>';
                    break;
                case 'custom':
                case 'suggest':
        ...
        this.initMask = function () {
            if (self.options.modal) {
                ...
                self.mh = $("<div id='dialog-mask' class='dialog-mask'></div>")
        ...
        this.initContent = function (content) {
            ...
            if (self.options.type == 'suggest') {//例外处理
                ...
                if (self.options.contentType == "selector") {
                    ...
                    html += ('\n</style>');
                    html += ('<iframe class="dialogIframe" id="dialogIframe" src="' + self._content + '" width="100%" height="100%" frameborder="0"></iframe>');
                    self.setContent(html);
                    self.onopen();
                    self.show();
                } else {
